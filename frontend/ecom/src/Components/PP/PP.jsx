      ...
      <div class="lg:col-span-3 lg:row-end-1">
        <div class="lg:flex lg:items-start">
          <div class="lg:order-2 lg:ml-5">
            <div class="h-92 w-92 bg-red-500 overflow-hidden rounded-lg">
              <img class="h-full w-full object-cover w" src={imagePaths[index]} alt="" />
            </div>
          </div>
          ...
          <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
            ...
            <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center">
                <img class="h-full w-full object-cover" src={imagePaths[0]} onClick={()=>{setindex(0)}} alt="" />
              </button>
              <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center">
                <img class="h-full w-full object-cover" src={imagePaths[1]} onClick={()=>{setindex(1)}} alt="" />
              </button>
              <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-transparent text-center">
                <img class="h-full w-full object-cover" src={imagePaths[2]}  onClick={()=>{setindex(2)}} alt="" />
              </button>
              <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-transparent text-center">
                <img class="h-full w-full object-cover" src={imagePaths[3]} onClick={()=>{setindex(3)}} alt="" />
              </button>
            </div>
          </div>
        </div>
